...
class _Uklatn_uk_uk_Latn_DSTU_9112_A {
    constructor() {
        this._rx1 = /(?<=^|[^\p{L}\p{M}\p{N}])([Ьь])|([Ьь](?=[АаЕеУу])|[ЄЮЯ](?=\u0301?[а-щьюяєіїґ’])|(?<=[Б-ДЖЗК-НП-ТФ-Щб-джзк-нп-тф-щҐґ])[Йй])|(А|а|Б|б|В|в|Г|г|Ґ|ґ|Д|д|Е|е|Є|є|Ж|ж|З|з|И|и|І|і|Ї|ї|К|к|Л|л|М|м|Н|н|О|о|П|п|Р|р|С|с|Т|т|У|у|Ф|ф|Х|х|Ц|ц|Ч|ч|Ш|ш|Щ|щ|Ю|ю|Я|я|Ь|ь|Й|й|’|Ё|ё|Ў|ў|Ъ|ъ|Ы|ы|Э|э)/gu;
...
class _Uklatn_uk_Latn_DSTU_9112_A_uk {
    constructor() {
        ...
        this._rx2 = /(A|a|B|b|V|v|Ğ|ğ|G|g|D|d|E|e|J[Ee]|j[Ee]|Ž|ž|Z|z|Y|y|I|i|Ï|ï|K|k|L|l|M|m|N|n|O|o|P|p|R|r|S|s|T|t|U|u|F|f|X|x|C|c|Č|č|Š|š|Ŝ|ŝ|J[Uu]|j[Uu]|J[Aa]|j[Aa]|Ĵ|ĵ|Ö|ö|Ŭ|ŭ|Ǒ|ǒ|Ȳ|ȳ|Ē|ē)|(?<=[BbCcDdFfGgKkLlMmNnPpRrSsTtVvXxZzČčĞğŜŝŠšŽž])([Jj]\u0027(?=[AaEeUu])|[Jj])|(\u0027[Jj](?![AaEeIiUu])|\u0027(?=[Jj])|[Jj])/gu;
        const _maps2 = [undefined, 
