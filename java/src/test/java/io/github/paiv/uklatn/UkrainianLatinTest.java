...
class UkrainianLatinTest {
    ...
    private String[][] data_DSTU_9112_A_c2lr = {
    {
    ...
    private String[][] data_DSTU_9112_A_c2l = {
    {
        "в’я в'я",
        "v'ja v'ja"
    },
    ...
    private String[][] data_DSTU_9112_A_l2c = {
    {
        "я є ю",
        "jA jE jU"
    },
    ...
    private String[][] data_DSTU_9112_B_c2lr = {
    {
        "Україна, Хмельницький",
    ...
    private String[][] data_DSTU_9112_B_c2l = {
    {
        "в’я в'я",
        "v'ja v'ja"
    },
    ...
    private String[][] data_DSTU_9112_B_l2c = {
    {
    ...
    @Test
    void test_DSTU_9112_B() {
        for (String[] pair : data_DSTU_9112_B_c2lr) {
            String q = tr.encode(pair[0], UKLatnTable.DSTU_9112_B);
            assertEquals(pair[1], q);
            String t = tr.decode(pair[1], UKLatnTable.DSTU_9112_B);
            assertEquals(pair[0], t);
        }
        for (String[] pair : data_DSTU_9112_B_c2l) {
            String q = tr.encode(pair[0], UKLatnTable.DSTU_9112_B);
            assertEquals(pair[1], q);
        }
        for (String[] pair : data_DSTU_9112_B_l2c) {
            String q = tr.decode(pair[1], UKLatnTable.DSTU_9112_B);
            assertEquals(pair[0], q);
        }
    }

    private String[][] data_KMU_55_c2l = {
    {
        "Україна, Хмельницький",
    ...
    @Test
    void test_KMU_55() {
        for (String[] pair : data_KMU_55_c2l) {
            String q = tr.encode(pair[0], UKLatnTable.KMU_55);
            assertEquals(pair[1], q);
        }
    }
}
