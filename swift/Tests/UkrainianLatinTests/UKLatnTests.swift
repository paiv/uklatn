...
@Suite("DSTU_9112_A") struct Dstu9112ATests {

    @Test func c2lr_DSTU_9112_A() throws {
    ...
    @Test func c2l_DSTU_9112_A() throws {
        let data: [(String, String)] = [
        (
            "в’я в'я",
            "v'ja v'ja"
    ...
    @Test func l2c_DSTU_9112_A() throws {
        let data: [(String, String)] = [
        (
            "я є ю",
            "jA jE jU"
...
@Suite("DSTU_9112_B") struct Dstu9112BTests {

    @Test func c2lr_DSTU_9112_B() throws {
        let data: [(String, String)] = [
        (
            "Україна, Хмельницький",
    ...
    @Test func c2l_DSTU_9112_B() throws {
        let data: [(String, String)] = [
        (
            "в’я в'я",
            "v'ja v'ja"
    ...
    @Test func l2c_DSTU_9112_B() throws {
        let data: [(String, String)] = [
        (
...
@Suite("KMU_55") struct Kmu55Tests {

    @Test func c2l_KMU_55() throws {
        let data: [(String, String)] = [
        (
            "Україна, Хмельницький",
    ...
    @Test func decode_KMU_55_throws() throws {
