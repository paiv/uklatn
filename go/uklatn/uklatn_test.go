...
func TestDstu9112A(t *testing.T) {
	data_c2lr := [...][2]string{
		{
...
func FuzzDstu9112ADecode(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, in string) {
		...
		DecodeString(in, DSTU_9112_A)
	})
}

func FuzzDstu9112AEncode(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, in string) {
		...
		EncodeString(in, DSTU_9112_A)
	})
}

func TestDstu9112B(t *testing.T) {
	data_c2lr := [...][2]string{
		{
			"Україна, Хмельницький",
	...
	for _, cyrlat := range data_c2lr {
		enc := EncodeString(cyrlat[0], DSTU_9112_B)
		assertEqual(t, cyrlat[1], enc, "\n"+cyrlat[0])
		dec := DecodeString(cyrlat[1], DSTU_9112_B)
		assertEqual(t, cyrlat[0], dec, "\n"+cyrlat[1])
	}
...
func FuzzDstu9112BDecode(f *testing.F) {
	for _, seed := range [...]string{"", "A", "z"} {
		f.Add(seed)
	}
	f.Fuzz(func(t *testing.T, in string) {
		...
		DecodeString(in, DSTU_9112_B)
	})
}

func FuzzDstu9112BEncode(f *testing.F) {
	for _, seed := range [...]string{"", "А", "я"} {
		f.Add(seed)
	}
	f.Fuzz(func(t *testing.T, in string) {
		...
		EncodeString(in, DSTU_9112_B)
	})
}

func TestKmu55(t *testing.T) {
	data_c2l := [...][2]string{
		{
			"Україна, Хмельницький",
	...
	for _, cyrlat := range data_c2l {
		enc := EncodeString(cyrlat[0], KMU_55)
		assertEqual(t, cyrlat[1], enc, "\n"+cyrlat[0])
	}
}

func TestKmu55DecodePanic(t *testing.T) {
